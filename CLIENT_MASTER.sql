...
CREATE TABLE CLIENT_MASTER ( CLIENTNO varchar2(6), NAME varchar2(20), ADDRESS1 varchar2(30), ADDRESS2 varchar2(30), CITY varchar2(15), PINCODE number(8), STATE varchar2(15), BALDUE number(10, 2) );
DESC CLIENT_MASTER;
...
DESC CLIENT_MASTER;
UPDATE CLIENT_MASTER SET TELEPHONE = 1000000000;
ALTER TABLE CLIENT_MASTER RENAME COLUMN TELEPHONE TO MOBILE;
COMMIT;